    ...
    <div className="principal_muro">
        ...
        <div className='welcome-config'>
            ...
            <div className='box'>
                ...
                <div className='parraf_config'>
                    <h1> Escoge tasa de descuento <br></br> a trabajar </h1>

                    <div className='tasasNE'>
                        <p> Tasa Nominal </p> 
                        <input type="checkbox" name='tasanom'/>

                        <p> Tasa Efectiva </p> 
                        <input type="checkbox" name='tasaefect'/>
                    </div>

                    <h1> Tipo de cambio </h1>
                    <div className='tipocamb'>
                        <p> Soles peruanos (PEN) </p> 
                        <input type="checkbox" name='tasanom'/>
